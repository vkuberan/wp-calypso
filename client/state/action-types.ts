...
export const SIGNUP_STEPS_DIFM_SELECT_DIFM_CATEGORY = 'SIGNUP_STEPS_DIFM_SELECT_DIFM_CATEGORY';
export const SIGNUP_STEPS_DIFM_SUBMIT_TYPEFORM = 'SIGNUP_STEPS_DIFM_SUBMIT_TYPEFORM';
