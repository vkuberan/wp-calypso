...
function createPurchaseObject( purchase ) {
	const object = {
		...
		currentPriceTierSlug: purchase.current_price_tier_slug,
		currentPriceTierUsageQuantity: Number( purchase.current_price_tier_usage_quantity ),
		...
		renewalPriceTierSlug: purchase.renewal_price_tier_slug,
		renewalPriceTierUsageQuantity: Number( purchase.renewal_price_tier_usage_quantity ),
